...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"some.js":[function(require,module,exports) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  inputCoin.oninput = dropDownCoinsHTML;
}, false);
/* Rendering functions */

function dropDownCoinsHTML(event) {
  var inputValue = event.target.value;
  var filteredCoins = [];
  var inputIsempty = inputValue === "";
  filteredCoins = coins.filter(function (coin) {
  ...
  if (filteredCoins.length > 0 && !inputIsempty) {
    ...
    var _dropDownDiv = document.getElementById("myDropdown");

    removeChildren(_dropDownDiv);

    _dropDownDiv.classList.add("dropdown-content-hide");
  }
}

function addExhanges(event) {
  var coin = event.target.value;
  var newDiv = document.createElement("div");
  newDiv.classList.add("all-border");
  newDiv.classList.add("child-container");
  var newH1 = document.createElement("h1");
  var newContent = document.createTextNode(coin);
  newH1.appendChild(newContent);
  newDiv.appendChild(newH1);
  var currentDiv = document.getElementById("section-bottom");
...
},{"./some":"some.js"}],"C:/Users/user/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
